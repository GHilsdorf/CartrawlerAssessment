...
import com.cartrawler.assessment.car.CarService;
import com.cartrawler.assessment.utils.CarComparator;
...
public class AssessmentRunner {
    ...
    public static void main(String[] args) {
        ...
        List<CarResult> resultList = new ArrayList<>(CARS);
        
        prepareList(resultList, true);

        display.render(resultList);
    }

    public static void prepareList(List<CarResult> list, boolean applyeMedianRule) {

        if (applyeMedianRule) {
            //Find median based on the fuel policy and group and and remove cars above it.
            double corporateCarsMedian = CarService.findMedianByFuelPolicy(list, CarResult.FuelPolicy.FULLFULL, CarComparator.CORPORATE_CARS);
            CarService.removeCarAboveMedianByFuelPolicy(list, CarResult.FuelPolicy.FULLFULL, corporateCarsMedian, CarComparator.CORPORATE_CARS);

            double nonCorporateCarsMedian = CarService.findMedianByFuelPolicy(list, CarResult.FuelPolicy.FULLFULL, CarComparator.NON_CORPORATE_CARS);
            CarService.removeCarAboveMedianByFuelPolicy(list, CarResult.FuelPolicy.FULLFULL, nonCorporateCarsMedian, CarComparator.NON_CORPORATE_CARS);
        }
